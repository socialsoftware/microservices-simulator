...
public class FindQuestionByAggregateIdData extends WorkflowData {
    ...
    public FindQuestionByAggregateIdData(QuestionService questionService, SagaUnitOfWorkService unitOfWorkService,  
