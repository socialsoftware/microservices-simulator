package pt.ulisboa.tecnico.socialsoftware.crossrefs.microservices.teacher.coordination.functionalities;
...
import pt.ulisboa.tecnico.socialsoftware.crossrefs.microservices.teacher.coordination.sagas.*;
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                GetTeacherByIdFunctionalitySagas getTeacherByIdFunctionalitySagas = new GetTeacherByIdFunctionalitySagas(
                        sagaUnitOfWorkService, teacherAggregateId, sagaUnitOfWork, commandGateway);
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                UpdateTeacherFunctionalitySagas updateTeacherFunctionalitySagas = new UpdateTeacherFunctionalitySagas(
                        sagaUnitOfWorkService, teacherDto, sagaUnitOfWork, commandGateway);
