...
public class ExecutionUpdatedEventHandler extends TournamentEventHandler {
    public ExecutionUpdatedEventHandler(TournamentRepository tournamentRepository, TournamentEventProcessing tournamentEventProcessing) {
        super(tournamentRepository, tournamentEventProcessing);
    }

    @Override
    public void handleEvent(Integer subscriberAggregateId, Event event) {
        this.tournamentEventProcessing.processExecutionUpdatedEvent(subscriberAggregateId, (ExecutionUpdatedEvent) event);
    }
}
