...
@Documented
@Constraint(validatedBy = ContactBusinessRuleValidator.class)
@Target({ElementType.FIELD, ElementType.METHOD})
@Retention(RetentionPolicy.RUNTIME)
public @interface ValidContactBusinessRule {
    String message() default "Contact must comply with business rules";
