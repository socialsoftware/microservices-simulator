...
public class UpdateEnrollmentTeacherCommand extends Command {
    private final Integer enrollmentId;
    private final Integer teacherAggregateId;
    private final EnrollmentTeacherDto teacherDto;

    public UpdateEnrollmentTeacherCommand(UnitOfWork unitOfWork, String serviceName, Integer enrollmentId, Integer teacherAggregateId, EnrollmentTeacherDto teacherDto) {
