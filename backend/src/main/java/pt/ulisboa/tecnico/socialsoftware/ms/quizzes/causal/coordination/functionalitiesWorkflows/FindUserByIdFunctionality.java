...
public class FindUserByIdFunctionality extends WorkflowFunctionality {
    ...
    public FindUserByIdFunctionality(UserService userService, CausalUnitOfWorkService unitOfWorkService,  
