...
public class QuizCourseExecution {
    ...
    public QuizCourseExecution(Integer courseExecutionAggregateId, String courseExecutionName, String courseExecutionAcronym, String courseExecutionAcademicTerm) {
