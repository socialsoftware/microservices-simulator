...
public abstract class Shipping extends Aggregate {
    ...
    public Shipping(Shipping other) {
        super(other);
        setOrder(new ShippingOrder(other.getOrder()));
