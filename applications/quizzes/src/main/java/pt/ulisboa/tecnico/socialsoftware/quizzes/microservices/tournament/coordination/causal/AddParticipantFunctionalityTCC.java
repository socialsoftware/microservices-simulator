...
public class AddParticipantFunctionalityTCC extends WorkflowFunctionality {
    ...
    public void buildWorkflow(Integer tournamentAggregateId, Integer userAggregateId, CausalUnitOfWork unitOfWork) {
        ...
        Step step = new Step(() -> {
            ...
            GetStudentByExecutionIdAndUserIdCommand getStudentByExecutionIdAndUserIdCommand = new GetStudentByExecutionIdAndUserIdCommand(unitOfWork, ServiceMapping.EXECUTION.getServiceName(), tournamentDto.getCourseExecution().getAggregateId(), userAggregateId);
