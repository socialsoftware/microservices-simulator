...
import pt.ulisboa.tecnico.socialsoftware.tutorial.sagas.coordination.member.*;
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                CreateMemberFunctionalitySagas createMemberFunctionalitySagas = new CreateMemberFunctionalitySagas(
                        sagaUnitOfWork, sagaUnitOfWorkService, memberService, createRequest);
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                GetMemberByIdFunctionalitySagas getMemberByIdFunctionalitySagas = new GetMemberByIdFunctionalitySagas(
                        sagaUnitOfWork, sagaUnitOfWorkService, memberService, memberAggregateId);
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                UpdateMemberFunctionalitySagas updateMemberFunctionalitySagas = new UpdateMemberFunctionalitySagas(
                        sagaUnitOfWork, sagaUnitOfWorkService, memberService, memberDto);
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                GetAllMembersFunctionalitySagas getAllMembersFunctionalitySagas = new GetAllMembersFunctionalitySagas(
                        sagaUnitOfWork, sagaUnitOfWorkService, memberService);
