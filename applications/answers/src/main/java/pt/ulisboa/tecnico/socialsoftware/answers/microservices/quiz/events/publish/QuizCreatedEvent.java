...
public class QuizCreatedEvent extends Event {
    ...
    public QuizCreatedEvent(Integer aggregateId, String title, QuizType quizType, LocalDateTime creationDate, LocalDateTime availableDate, LocalDateTime conclusionDate, LocalDateTime resultsDate, QuizExecution execution, Set<QuizQuestion> questions) {
        super(aggregateId);
        setTitle(title);
