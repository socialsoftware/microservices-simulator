...
public class FindQuestionByAggregateIdFunctionalitySagas extends WorkflowFunctionality {
    ...
    public FindQuestionByAggregateIdFunctionalitySagas(QuestionService questionService, SagaUnitOfWorkService sagaUnitOfWorkService, SagaUnitOfWork unitOfWork) {
