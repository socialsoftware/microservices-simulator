...
mkdir -p /out/classes
javac -cp "$cp_value" -d /out/classes /experiment/GenerateUpdateReadPackage.java
java -Xmx2g -cp "/out/classes:$cp_value" GenerateUpdateReadPackage "$build/source" /experiment/descriptor /out/package
