...
public class QuizzesTestFactory {
    ...
    public static final String TOURNAMENT_AGGREGATE_TYPE = "SagaTournament";
    public static final String EXECUTION_AGGREGATE_TYPE = "SagaExecution";
    public static final String TOPIC_AGGREGATE_TYPE = "SagaTopic";
    public static final String QUESTION_AGGREGATE_TYPE = "SagaQuestion";
    public static final String QUIZ_AGGREGATE_TYPE = "SagaQuiz";
    public static final String USER_AGGREGATE_TYPE = "SagaUser";
