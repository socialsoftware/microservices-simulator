...
public class DeleteUserFunctionality extends WorkflowFunctionality {
    ...
    public DeleteUserFunctionality(UserService userService, SagaUnitOfWorkService unitOfWorkService,  
