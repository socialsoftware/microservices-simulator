...
@Entity
public class DisenrollStudentFromExecutionEvent extends Event {
    private Integer executionAggregateId;
    private Integer studentAggregateId;
    private String studentName;

    public DisenrollStudentFromExecutionEvent() {
    }

    public DisenrollStudentFromExecutionEvent(Integer aggregateId, Integer executionAggregateId, Integer studentAggregateId, String studentName) {
        super(aggregateId);
