...
import pt.ulisboa.tecnico.socialsoftware.eventdriven.sagas.coordination.author.*;
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                CreateAuthorFunctionalitySagas createAuthorFunctionalitySagas = new CreateAuthorFunctionalitySagas(
                        sagaUnitOfWork, sagaUnitOfWorkService, authorService, createRequest);
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                GetAuthorByIdFunctionalitySagas getAuthorByIdFunctionalitySagas = new GetAuthorByIdFunctionalitySagas(
                        sagaUnitOfWork, sagaUnitOfWorkService, authorService, authorAggregateId);
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                UpdateAuthorFunctionalitySagas updateAuthorFunctionalitySagas = new UpdateAuthorFunctionalitySagas(
                        sagaUnitOfWork, sagaUnitOfWorkService, authorService, authorDto);
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                GetAllAuthorsFunctionalitySagas getAllAuthorsFunctionalitySagas = new GetAllAuthorsFunctionalitySagas(
                        sagaUnitOfWork, sagaUnitOfWorkService, authorService);
