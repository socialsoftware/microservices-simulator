...
@ControllerAdvice
public class EventdrivenExceptionHandler {
    private static final Logger logger = LoggerFactory.getLogger(EventdrivenExceptionHandler.class);

    @ExceptionHandler(EventdrivenException.class)
    public ResponseEntity<String> handleEventdrivenException(EventdrivenException ex) {
        logger.warn("Handled EventdrivenException: {}", ex.getErrorMessage());
