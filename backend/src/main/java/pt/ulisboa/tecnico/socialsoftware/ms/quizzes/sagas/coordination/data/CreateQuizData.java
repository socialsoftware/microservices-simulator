...
public class CreateQuizData extends WorkflowData {
    ...
    public CreateQuizData(CourseExecutionService courseExecutionService, QuizService quizService, QuestionService questionService, SagaUnitOfWorkService unitOfWorkService,  
