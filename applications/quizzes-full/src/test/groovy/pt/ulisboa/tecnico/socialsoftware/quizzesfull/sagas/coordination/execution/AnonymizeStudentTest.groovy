...
class AnonymizeStudentTest extends QuizzesFullSpockTest {
    ...
    def "anonymizeStudent: getExecutionStep acquires IN_ANONYMIZE_STUDENT semantic lock"() {
        ...
        def uow1 = unitOfWorkService.createUnitOfWork("anonymizeStudent")
        def func1 = new AnonymizeStudentFunctionalitySagas(
        ...
        sagaStateOf(executionDto.aggregateId) == ExecutionSagaState.IN_ANONYMIZE_STUDENT
