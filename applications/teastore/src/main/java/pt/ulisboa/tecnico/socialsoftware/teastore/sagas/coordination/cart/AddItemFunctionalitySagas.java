...
public class AddItemFunctionalitySagas extends WorkflowFunctionality {
    
        private final CartService cartService;
    private final SagaUnitOfWorkService sagaUnitOfWorkService;
    private final SagaUnitOfWork unitOfWork;

    public AddItemFunctionalitySagas(CartService cartService, SagaUnitOfWorkService sagaUnitOfWorkService, SagaUnitOfWork unitOfWork) {
