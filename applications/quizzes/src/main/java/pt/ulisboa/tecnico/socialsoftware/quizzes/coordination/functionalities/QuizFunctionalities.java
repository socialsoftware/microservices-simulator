...
import pt.ulisboa.tecnico.socialsoftware.quizzes.causal.coordination.quiz.UpdateQuizFunctionalityTCC;
...
import pt.ulisboa.tecnico.socialsoftware.quizzes.sagas.coordination.quiz.CreateQuizFunctionalitySagas;
...
public class QuizFunctionalities {
    ...
    public List<QuizDto> getAvailableQuizzes(Integer userAggregateId, Integer courseExecutionAggregateId) {
        ...
        GetAvailableQuizzesFunctionalityTCC getAvailableQuizzesFunctionalityTCC = new GetAvailableQuizzesFunctionalityTCC(
            causalUnitOfWorkService, courseExecutionAggregateId, courseExecutionAggregateId, causalUnitOfWork, commandGateway);
