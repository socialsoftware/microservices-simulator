...
public class FindQuestionsByCourseAggregateIdFunctionalitySagas extends WorkflowFunctionality {
    ...
    public FindQuestionsByCourseAggregateIdFunctionalitySagas(QuestionService questionService, SagaUnitOfWorkService sagaUnitOfWorkService, SagaUnitOfWork unitOfWork) {
