...
public class GetTopicByIdFunctionality extends WorkflowFunctionality {
    ...
    public GetTopicByIdFunctionality(TopicService topicService, CausalUnitOfWorkService unitOfWorkService,  
