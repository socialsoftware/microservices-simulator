...
class PayOrderCompensationTest extends TrainticketSpockTest {
    ...
    def "payOrder: fault on payOrderStep compensates the lock acquired by getOrderStep"() {
        // Spec: plan.md §8 Order - PayOrder; compensate transition
        when:
        ...
        and: 'the payOrder never ran: read-back shows the pre-saga state'
