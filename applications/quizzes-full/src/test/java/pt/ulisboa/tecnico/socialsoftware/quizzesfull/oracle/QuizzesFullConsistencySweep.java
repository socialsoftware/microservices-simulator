...
class QuizzesFullConsistencySweep {

    private static final Logger log = LoggerFactory.getLogger(QuizzesFullConsistencySweep.class);
    private static final int DEFAULT_ITERATIONS = 20;

    @Test
    void sweepsApplication() {
        int iterations = Integer.getInteger("consistency.iterations", DEFAULT_ITERATIONS);
        Orchestrator orchestrator = Orchestrator.of(QuizzesFullSimulator.class)
