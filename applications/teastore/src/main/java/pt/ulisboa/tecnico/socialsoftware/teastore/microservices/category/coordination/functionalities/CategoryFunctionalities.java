package pt.ulisboa.tecnico.socialsoftware.teastore.microservices.category.coordination.functionalities;
...
import pt.ulisboa.tecnico.socialsoftware.teastore.microservices.category.coordination.sagas.*;
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                GetCategoryByIdFunctionalitySagas getCategoryByIdFunctionalitySagas = new GetCategoryByIdFunctionalitySagas(
                        sagaUnitOfWorkService, categoryAggregateId, sagaUnitOfWork, commandGateway);
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                UpdateCategoryFunctionalitySagas updateCategoryFunctionalitySagas = new UpdateCategoryFunctionalitySagas(
                        sagaUnitOfWorkService, categoryDto, sagaUnitOfWork, commandGateway);
