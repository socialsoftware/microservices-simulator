...
| Runtime input attribution improves exact static/dynamic joining for the current comparable Quizzes sagas-local baseline. | [`current-state.md`](current-state.md), [`evidence.md`](evidence.md), [`reference/dynamic-enrichment.md`](reference/dynamic-enrichment.md), [`decisions/2026-05-12-runtime-input-variant-attribution.md`](decisions/2026-05-12-runtime-input-variant-attribution.md) | Latest post-event baseline: `584` scenario records, `dynamicEventsRead=26820`, `MATCHED_EXACT=291`, `MATCHED_HIGH_CONFIDENCE=109`, `AMBIGUOUS=0`, `UNMATCHED=184`, `warningCount=0`. Older pre-attribution baseline had `MATCHED_EXACT=0`, `MATCHED_HIGH_CONFIDENCE=2`, `AMBIGUOUS=44`, `UNMATCHED=20`, `warningCount=8238`. | Do not generalize this result to stream/gRPC/distributed execution, causal/TCC runtime hooks, arbitrary applications, or full static-catalog validation. `UNMATCHED=184` remains. |
