...
public class ProductDeletedEventHandler extends WishlistItemEventHandler {
    public ProductDeletedEventHandler(WishlistItemRepository wishlistitemRepository, WishlistItemEventProcessing wishlistitemEventProcessing) {
        super(wishlistitemRepository, wishlistitemEventProcessing);
    }

    @Override
    public void handleEvent(Integer subscriberAggregateId, Event event) {
        this.wishlistitemEventProcessing.processProductDeletedEvent(subscriberAggregateId, (ProductDeletedEvent) event);
    }
}
