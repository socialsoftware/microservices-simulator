...
public class UpdateItemFunctionalitySagas extends WorkflowFunctionality {
    
        private final CartService cartService;
    private final SagaUnitOfWorkService sagaUnitOfWorkService;
    private final SagaUnitOfWork unitOfWork;

    public UpdateItemFunctionalitySagas(CartService cartService, SagaUnitOfWorkService sagaUnitOfWorkService, SagaUnitOfWork unitOfWork) {
