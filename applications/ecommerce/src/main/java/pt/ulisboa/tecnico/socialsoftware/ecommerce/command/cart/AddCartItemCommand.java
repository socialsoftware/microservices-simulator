...
public class AddCartItemCommand extends Command {
    private final Integer cartId;
    private final Integer quantity;
    private final CartItemDto itemDto;

    public AddCartItemCommand(UnitOfWork unitOfWork, String serviceName, Integer cartId, Integer quantity, CartItemDto itemDto) {
