...
public class RemoveEnrollmentTeacherCommand extends Command {
    private final Integer enrollmentId;
    private final Integer teacherAggregateId;

    public RemoveEnrollmentTeacherCommand(UnitOfWork unitOfWork, String serviceName, Integer enrollmentId, Integer teacherAggregateId) {
