...
public class GetOpenedTournamentsForExecutionFunctionalitySagas extends WorkflowFunctionality {
    private List<TournamentDto> tournaments;

    public GetOpenedTournamentsForExecutionFunctionalitySagas(SagaUnitOfWorkService unitOfWorkService,
    ...
    public void buildWorkflow(SagaUnitOfWorkService unitOfWorkService,
        ...
        SagaStep getOpenedTournamentsForExecutionStep = new SagaStep(
                "getOpenedTournamentsForExecutionStep", () -> {
            GetOpenedTournamentsForExecutionCommand cmd = new GetOpenedTournamentsForExecutionCommand(
        ...
        this.workflow.addStep(getOpenedTournamentsForExecutionStep);
    }
