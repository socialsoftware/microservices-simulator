...
public class ReserveFunctionalitySagas extends WorkflowFunctionality {
    ...
    public ReserveFunctionalitySagas(SagaUnitOfWorkService sagaUnitOfWorkService, RoomService roomService, Integer roomId, SagaUnitOfWork unitOfWork, CommandGateway commandGateway) {
    ...
    public void buildWorkflow(Integer roomId) {
        ...
        SagaStep reserveStep = new SagaStep("reserveStep", () -> {
            this.roomService.reserve(roomId, this.unitOfWork);
        });
        this.workflow.addStep(reserveStep);
    }
