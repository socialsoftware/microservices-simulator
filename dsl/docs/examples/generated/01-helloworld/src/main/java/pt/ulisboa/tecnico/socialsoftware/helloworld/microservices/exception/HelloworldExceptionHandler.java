...
public class HelloworldExceptionHandler {
    private static final Logger logger = LoggerFactory.getLogger(HelloworldExceptionHandler.class);

    @ExceptionHandler(HelloworldException.class)
    public ResponseEntity<String> handleHelloworldException(HelloworldException ex) {
        logger.warn("Handled HelloworldException: {}", ex.getErrorMessage());
