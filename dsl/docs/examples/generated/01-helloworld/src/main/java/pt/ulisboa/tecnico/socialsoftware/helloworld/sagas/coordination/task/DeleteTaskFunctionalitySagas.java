...
public class DeleteTaskFunctionalitySagas extends WorkflowFunctionality {
    ...
    public DeleteTaskFunctionalitySagas(SagaUnitOfWork unitOfWork, SagaUnitOfWorkService unitOfWorkService, TaskService taskService, Integer taskAggregateId) {
    ...
    public void buildWorkflow(Integer taskAggregateId, SagaUnitOfWork unitOfWork) {
        ...
        SagaSyncStep deleteTaskStep = new SagaSyncStep("deleteTaskStep", () -> {
            taskService.deleteTask(taskAggregateId, unitOfWork);
        });
