...
public class CheckoutCartFunctionalitySagas extends WorkflowFunctionality {
    
        private final CartService cartService;
    private final SagaUnitOfWorkService sagaUnitOfWorkService;
    private final SagaUnitOfWork unitOfWork;

    public CheckoutCartFunctionalitySagas(CartService cartService, SagaUnitOfWorkService sagaUnitOfWorkService, SagaUnitOfWork unitOfWork) {
