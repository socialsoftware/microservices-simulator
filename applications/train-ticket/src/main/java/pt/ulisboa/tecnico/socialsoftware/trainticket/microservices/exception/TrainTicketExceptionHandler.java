...
public class TrainTicketExceptionHandler {
    private static final Logger logger = LoggerFactory.getLogger(TrainTicketExceptionHandler.class);

    @ExceptionHandler(TrainTicketException.class)
    public ResponseEntity<String> handleTrainTicketException(TrainTicketException ex) {
        logger.warn("Handled TrainTicketException: {}", ex.getErrorMessage());
