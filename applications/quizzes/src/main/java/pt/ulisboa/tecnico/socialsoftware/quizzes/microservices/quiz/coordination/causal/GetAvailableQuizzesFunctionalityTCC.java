...
import pt.ulisboa.tecnico.socialsoftware.quizzes.commands.quiz.GetAvailableQuizzesCommand;
...
public class GetAvailableQuizzesFunctionalityTCC extends WorkflowFunctionality {
    ...
    public void buildWorkflow(Integer userAggregateId, Integer courseExecutionAggregateId,
        ...
        Step step = new Step(() -> {
            ...
            this.availableQuizzes = (List<QuizDto>) commandGateway.send(GetAvailableQuizzesCommand);
        });
