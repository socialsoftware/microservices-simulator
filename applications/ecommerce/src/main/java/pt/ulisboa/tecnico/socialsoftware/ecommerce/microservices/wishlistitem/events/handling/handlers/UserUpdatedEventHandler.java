...
public class UserUpdatedEventHandler extends WishlistItemEventHandler {
    public UserUpdatedEventHandler(WishlistItemRepository wishlistitemRepository, WishlistItemEventProcessing wishlistitemEventProcessing) {
        super(wishlistitemRepository, wishlistitemEventProcessing);
    }

    @Override
    public void handleEvent(Integer subscriberAggregateId, Event event) {
        this.wishlistitemEventProcessing.processUserUpdatedEvent(subscriberAggregateId, (UserUpdatedEvent) event);
    }
}
