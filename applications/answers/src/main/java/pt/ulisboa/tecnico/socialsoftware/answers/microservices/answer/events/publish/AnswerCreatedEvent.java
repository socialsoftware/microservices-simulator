...
@Entity
public class AnswerCreatedEvent extends Event {
    ...
    public AnswerCreatedEvent(Integer aggregateId, LocalDateTime creationDate, LocalDateTime answerDate, Boolean completed, AnswerExecution execution, AnswerUser user, AnswerQuiz quiz, List<QuestionAnswered> questions) {
        super(aggregateId);
