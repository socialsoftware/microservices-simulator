...
import pt.ulisboa.tecnico.socialsoftware.trainticket.microservices.user.coordination.sagas.*;
...
public class UserFunctionalities {
    ...
    private void checkInput(UserDto userDto) {
        if (userDto.getUserName() == null) {
            throw new TrainTicketException(USER_MISSING_USERNAME);
        }
        if (userDto.getPassword() == null) {
            throw new TrainTicketException(USER_MISSING_PASSWORD);
        }
        if (userDto.getDocumentNum() == null) {
            throw new TrainTicketException(USER_MISSING_DOCUMENTNUM);
        }
        if (userDto.getEmail() == null) {
            throw new TrainTicketException(USER_MISSING_EMAIL);
        }
}
    ...
    private void checkInput(CreateUserRequestDto createRequest) {
        ...
        if (createRequest.getDocumentNum() == null) {
            throw new TrainTicketException(USER_MISSING_DOCUMENTNUM);
        }
