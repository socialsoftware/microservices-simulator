...
class DeleteContactsCompensationTest extends TrainticketSpockTest {
    ...
    def "deleteContacts: fault on deleteContactsStep compensates the lock acquired by getContactsStep"() {
        // Spec: plan.md §5 Contacts - DeleteContacts; compensate transition
        when:
        ...
        and: 'the soft delete never ran: read-back still resolves the contact'
