...
public class AddRouteStationCommand extends Command {
    private final Integer routeId;
    private final Integer stationAggregateId;
    private final RouteStationDto stationDto;

    public AddRouteStationCommand(UnitOfWork unitOfWork, String serviceName, Integer routeId, Integer stationAggregateId, RouteStationDto stationDto) {
