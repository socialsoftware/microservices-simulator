...
public class CreateTopicData extends WorkflowData {
    ...
    public CreateTopicData(TopicService topicService, CourseService courseService, SagaUnitOfWorkService unitOfWorkService,  
