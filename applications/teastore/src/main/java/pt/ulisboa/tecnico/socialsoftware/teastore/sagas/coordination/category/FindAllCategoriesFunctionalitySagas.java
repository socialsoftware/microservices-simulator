...
public class FindAllCategoriesFunctionalitySagas extends WorkflowFunctionality {
    
        private final CategoryService categoryService;
    private final SagaUnitOfWorkService sagaUnitOfWorkService;
    private final SagaUnitOfWork unitOfWork;

    public FindAllCategoriesFunctionalitySagas(CategoryService categoryService, SagaUnitOfWorkService sagaUnitOfWorkService, SagaUnitOfWork unitOfWork) {
