...
public class GetEnrollmentByIdFunctionalitySagas extends WorkflowFunctionality {
    ...
    public void buildWorkflow(Integer enrollmentAggregateId, SagaUnitOfWork unitOfWork) {
        ...
        SagaStep getEnrollmentStep = new SagaStep("getEnrollmentStep", () -> {
            unitOfWorkService.verifySagaState(enrollmentAggregateId, new java.util.ArrayList<SagaState>(java.util.Arrays.asList(EnrollmentSagaState.UPDATE_ENROLLMENT, EnrollmentSagaState.DELETE_ENROLLMENT)));
            unitOfWorkService.registerSagaState(enrollmentAggregateId, EnrollmentSagaState.READ_ENROLLMENT, unitOfWork);
