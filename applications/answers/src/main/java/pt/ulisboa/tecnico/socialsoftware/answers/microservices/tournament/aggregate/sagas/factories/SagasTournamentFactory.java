package pt.ulisboa.tecnico.socialsoftware.answers.microservices.tournament.aggregate.sagas.factories;
...
import pt.ulisboa.tecnico.socialsoftware.answers.microservices.tournament.aggregate.sagas.dtos.SagaTournamentDto;
...
public class SagasTournamentFactory implements TournamentFactory {
    ...
    public Tournament createTournament(Integer aggregateId, TournamentDto tournamentDto) {
        return new SagaTournament(aggregateId, tournamentDto);
    }
