...
public class IncrementQuestionCountCommand extends Command {
    private final Integer courseAggregateId;

    public IncrementQuestionCountCommand(UnitOfWork unitOfWork, String serviceName, Integer courseAggregateId) {
