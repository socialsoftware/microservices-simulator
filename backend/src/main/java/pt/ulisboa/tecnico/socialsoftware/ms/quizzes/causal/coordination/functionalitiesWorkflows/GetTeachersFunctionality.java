...
public class GetTeachersFunctionality extends WorkflowFunctionality {
    ...
    public GetTeachersFunctionality(UserService userService, CausalUnitOfWorkService unitOfWorkService,  
