...
public class DeleteUserFunctionalitySagas extends WorkflowFunctionality {
    ...
    public DeleteUserFunctionalitySagas(SagaUnitOfWorkService unitOfWorkService, Integer userAggregateId,
    ...
    public void buildWorkflow(SagaUnitOfWorkService unitOfWorkService, Integer userAggregateId,
        ...
        SagaStep getUserStep = new SagaStep("getUserStep", () -> {
            ...
            sagaCommand.setSemanticLock(UserSagaState.IN_DELETE_USER);
        ...
        this.workflow.addStep(deleteUserStep);
    }
