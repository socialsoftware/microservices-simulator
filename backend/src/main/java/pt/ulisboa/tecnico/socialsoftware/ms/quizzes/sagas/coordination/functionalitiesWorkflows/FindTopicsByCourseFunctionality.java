...
public class FindTopicsByCourseFunctionality extends WorkflowFunctionality {
    ...
    public FindTopicsByCourseFunctionality(TopicService topicService, SagaUnitOfWorkService unitOfWorkService,  
