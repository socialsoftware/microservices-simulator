...
public class DeleteEnrollmentFunctionalitySagas extends WorkflowFunctionality {
    ...
    public DeleteEnrollmentFunctionalitySagas(SagaUnitOfWork unitOfWork, SagaUnitOfWorkService unitOfWorkService, EnrollmentService enrollmentService, Integer enrollmentAggregateId) {
    ...
    public void buildWorkflow(Integer enrollmentAggregateId, SagaUnitOfWork unitOfWork) {
        ...
        SagaSyncStep deleteEnrollmentStep = new SagaSyncStep("deleteEnrollmentStep", () -> {
            enrollmentService.deleteEnrollment(enrollmentAggregateId, unitOfWork);
        });
