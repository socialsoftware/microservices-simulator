...
class CollectTicketCompensationTest extends TrainticketSpockTest {
    ...
    def "collectTicket: fault on collectTicketStep compensates the lock acquired by getOrderStep"() {
        // Spec: plan.md §8 Order - CollectTicket; compensate transition
        when:
        ...
        and: 'the collectTicket never ran: read-back shows the pre-saga state'
