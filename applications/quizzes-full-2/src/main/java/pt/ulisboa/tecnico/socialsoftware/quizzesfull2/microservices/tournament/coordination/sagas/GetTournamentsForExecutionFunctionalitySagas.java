...
public class GetTournamentsForExecutionFunctionalitySagas extends WorkflowFunctionality {
    private List<TournamentDto> tournaments;

    public GetTournamentsForExecutionFunctionalitySagas(SagaUnitOfWorkService unitOfWorkService,
    ...
    public void buildWorkflow(SagaUnitOfWorkService unitOfWorkService,
        ...
        SagaStep getTournamentsForExecutionStep = new SagaStep("getTournamentsForExecutionStep", () -> {
            GetTournamentsForExecutionCommand cmd = new GetTournamentsForExecutionCommand(
        ...
        this.workflow.addStep(getTournamentsForExecutionStep);
    }
