package pt.ulisboa.tecnico.socialsoftware.helloworld.microservices.task.coordination.functionalities;
...
import pt.ulisboa.tecnico.socialsoftware.helloworld.microservices.task.coordination.sagas.*;
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                GetTaskByIdFunctionalitySagas getTaskByIdFunctionalitySagas = new GetTaskByIdFunctionalitySagas(
                        sagaUnitOfWorkService, taskAggregateId, sagaUnitOfWork, commandGateway);
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                UpdateTaskFunctionalitySagas updateTaskFunctionalitySagas = new UpdateTaskFunctionalitySagas(
                        sagaUnitOfWorkService, taskDto, sagaUnitOfWork, commandGateway);
