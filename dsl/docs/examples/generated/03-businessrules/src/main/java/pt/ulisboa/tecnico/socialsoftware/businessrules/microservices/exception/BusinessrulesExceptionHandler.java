...
public class BusinessrulesExceptionHandler {
    private static final Logger logger = LoggerFactory.getLogger(BusinessrulesExceptionHandler.class);

    @ExceptionHandler(BusinessrulesException.class)
    public ResponseEntity<String> handleBusinessrulesException(BusinessrulesException ex) {
        logger.warn("Handled BusinessrulesException: {}", ex.getErrorMessage());
