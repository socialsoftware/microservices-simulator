...
**Critical:** `super(...)` must receive the same ID that consumers will use as `subscribedAggregateId`. Check `docs/concepts/inter-invariants.md` for the TCC implication.
