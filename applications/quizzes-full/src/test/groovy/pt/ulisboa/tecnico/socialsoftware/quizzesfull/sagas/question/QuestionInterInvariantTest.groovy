...
// T3 — Subscription (Inter-Invariant): consumer-side event handling for Question's subscribed
// events (TOPICS_EXIST). Producer-side event-store assertions are owned by TopicServiceTest.
@DataJpaTest
@Transactional
