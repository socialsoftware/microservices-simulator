...
public class RetireFunctionalitySagas extends WorkflowFunctionality {
    ...
    public RetireFunctionalitySagas(SagaUnitOfWorkService sagaUnitOfWorkService, RoomService roomService, Integer roomId, SagaUnitOfWork unitOfWork, CommandGateway commandGateway) {
    ...
    public void buildWorkflow(Integer roomId) {
        ...
        SagaStep retireStep = new SagaStep("retireStep", () -> {
            this.roomService.retire(roomId, this.unitOfWork);
        });
        this.workflow.addStep(retireStep);
    }
