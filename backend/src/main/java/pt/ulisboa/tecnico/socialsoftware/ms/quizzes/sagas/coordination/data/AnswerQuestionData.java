...
public class AnswerQuestionData extends WorkflowData {
    ...
    public AnswerQuestionData(QuizAnswerService quizAnswerService, QuestionService questionService, SagaUnitOfWorkService unitOfWorkService, QuizAnswerFactory quizAnswerFactory, 
