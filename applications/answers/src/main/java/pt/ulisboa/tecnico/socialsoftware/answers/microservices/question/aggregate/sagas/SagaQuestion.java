package pt.ulisboa.tecnico.socialsoftware.answers.microservices.question.aggregate.sagas;
...
public class SagaQuestion extends Question implements SagaAggregate {
    ...
    public SagaQuestion(Integer aggregateId, QuestionDto questionDto) {
        super(aggregateId, questionDto);
        this.sagaState = GenericSagaState.NOT_IN_SAGA;
    }
