...
public abstract class Invoice extends Aggregate {
    ...
    public Invoice(Invoice other) {
        super(other);
        setOrder(new InvoiceOrder(other.getOrder()));
        setUser(new InvoiceUser(other.getUser()));
    ...
    private boolean invariantInvoiceNumberNotEmpty() {
    ...
    public void verifyInvariants() {
        ...
        if (!invariantInvoiceNumberNotEmpty()) {
