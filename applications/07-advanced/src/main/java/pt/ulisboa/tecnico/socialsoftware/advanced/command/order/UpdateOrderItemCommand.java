...
public class UpdateOrderItemCommand extends Command {
    private final Integer orderId;
    private final Integer key;
    private final OrderItemDto itemDto;

    public UpdateOrderItemCommand(UnitOfWork unitOfWork, String serviceName, Integer orderId, Integer key, OrderItemDto itemDto) {
