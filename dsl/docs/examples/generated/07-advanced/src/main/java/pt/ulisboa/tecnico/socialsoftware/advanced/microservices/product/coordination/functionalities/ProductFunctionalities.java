package pt.ulisboa.tecnico.socialsoftware.advanced.microservices.product.coordination.functionalities;
...
import pt.ulisboa.tecnico.socialsoftware.advanced.microservices.product.coordination.sagas.*;
...
public class ProductFunctionalities {
    ...
    private void checkInput(ProductDto productDto) {
        if (productDto.getName() == null) {
            throw new AdvancedException(PRODUCT_MISSING_NAME);
        }
}
