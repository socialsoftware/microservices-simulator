...
public class QuizAnswerExecutionDto implements Serializable {
	private Integer executionAggregateId;
	private String executionName;
	private String executionAcronym;
	private String executionAcademicTerm;

	public QuizAnswerExecutionDto() {
	}

	public QuizAnswerExecutionDto(QuizAnswerExecution quizanswerexecution) {
		this.executionAggregateId = quizanswerexecution.getExecutionAggregateId();
		this.executionName = quizanswerexecution.getExecutionName();
		this.executionAcronym = quizanswerexecution.getExecutionAcronym();
		this.executionAcademicTerm = quizanswerexecution.getExecutionAcademicTerm();
	}
