...
public class FindByProductIdFunctionalitySagas extends WorkflowFunctionality {
    
        private final ProductService productService;
    private final SagaUnitOfWorkService sagaUnitOfWorkService;
    private final SagaUnitOfWork unitOfWork;

    public FindByProductIdFunctionalitySagas(ProductService productService, SagaUnitOfWorkService sagaUnitOfWorkService, SagaUnitOfWork unitOfWork) {
