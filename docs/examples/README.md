...
| UNIQUE_QUIZ_ANSWER_PER_STUDENT | Why combining Layer 3 + Layer 4 breaks strong consistency; the race window caused by reading an eventually-consistent cache in a supposedly-strong guard; and the correct alternatives (Layer 2 guard, DB constraint) | [unique-quiz-answer-per-student.md](unique-quiz-answer-per-student.md) |
