...
public class AddStudentData extends WorkflowData {
    ...
    public AddStudentData(CourseExecutionService courseExecutionService, UserService userService, SagaUnitOfWorkService unitOfWorkService, CourseExecutionFactory courseExecutionFactory, 
