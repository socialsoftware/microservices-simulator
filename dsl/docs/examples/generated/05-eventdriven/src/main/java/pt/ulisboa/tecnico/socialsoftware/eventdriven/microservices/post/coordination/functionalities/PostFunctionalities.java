package pt.ulisboa.tecnico.socialsoftware.eventdriven.microservices.post.coordination.functionalities;
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                GetPostByIdFunctionalitySagas getPostByIdFunctionalitySagas = new GetPostByIdFunctionalitySagas(
                        sagaUnitOfWorkService, postAggregateId, sagaUnitOfWork, commandGateway);
        ...
        switch (workflowType) {
            case SAGAS:
                ...
                UpdatePostFunctionalitySagas updatePostFunctionalitySagas = new UpdatePostFunctionalitySagas(
                        sagaUnitOfWorkService, postDto, sagaUnitOfWork, commandGateway);
