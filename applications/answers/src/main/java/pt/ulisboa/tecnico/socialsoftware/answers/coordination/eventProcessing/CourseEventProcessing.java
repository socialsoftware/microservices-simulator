...
import com.generated.microservices.answers.microservices.course.service.CourseService;
...
public class CourseEventProcessing {
    ...
    public void processCourseEvent(String eventType, Integer aggregateId, Integer aggregateVersion) {
