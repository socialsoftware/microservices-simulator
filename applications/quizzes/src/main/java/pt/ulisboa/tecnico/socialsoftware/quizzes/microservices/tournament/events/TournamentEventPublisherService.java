...
@Component
@Profile("stream")
public class TournamentEventPublisherService extends EventPublisherService {

    public TournamentEventPublisherService(EventRepository eventRepository, StreamBridge streamBridge,
