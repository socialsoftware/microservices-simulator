...
1. Write T2-style tests (happy path + P3 guard violations; floor/ceiling for count methods) — no saga step interleaving needed. P1 intra-invariant violations are not tested here; they belong in `{Aggregate}IntraInvariantTest.groovy`.
