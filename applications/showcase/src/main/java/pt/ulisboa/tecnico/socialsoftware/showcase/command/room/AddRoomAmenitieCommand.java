...
public class AddRoomAmenitieCommand extends Command {
    private final Integer roomId;
    private final Integer code;
    private final RoomAmenityDto amenitieDto;

    public AddRoomAmenitieCommand(UnitOfWork unitOfWork, String serviceName, Integer roomId, Integer code, RoomAmenityDto amenitieDto) {
