...
public class ActivateUserFunctionality extends WorkflowFunctionality {
    ...
    public ActivateUserFunctionality(UserService userService, CausalUnitOfWorkService unitOfWorkService,  
