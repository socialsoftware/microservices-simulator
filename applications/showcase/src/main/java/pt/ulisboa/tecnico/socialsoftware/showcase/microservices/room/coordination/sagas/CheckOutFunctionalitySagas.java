...
public class CheckOutFunctionalitySagas extends WorkflowFunctionality {
    ...
    public CheckOutFunctionalitySagas(SagaUnitOfWorkService sagaUnitOfWorkService, RoomService roomService, Integer roomId, SagaUnitOfWork unitOfWork, CommandGateway commandGateway) {
    ...
    public void buildWorkflow(Integer roomId) {
        ...
        SagaStep checkOutStep = new SagaStep("checkOutStep", () -> {
            this.roomService.checkOut(roomId, this.unitOfWork);
        });
        this.workflow.addStep(checkOutStep);
    }
