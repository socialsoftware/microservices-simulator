...
public class UpdateStationFunctionalitySagas extends WorkflowFunctionality {
    ...
    public UpdateStationFunctionalitySagas(SagaUnitOfWorkService unitOfWorkService,
                                           Integer stationAggregateId, StationDto updatedStationDto,
                                           SagaUnitOfWork unitOfWork, CommandGateway commandGateway) {
        this.unitOfWorkService = unitOfWorkService;
        this.commandGateway = commandGateway;
        buildWorkflow(stationAggregateId, updatedStationDto, unitOfWork);
    }

    public void buildWorkflow(Integer stationAggregateId, StationDto updatedStationDto, SagaUnitOfWork unitOfWork) {
