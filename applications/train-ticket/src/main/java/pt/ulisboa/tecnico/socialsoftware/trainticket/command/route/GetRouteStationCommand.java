...
public class GetRouteStationCommand extends Command {
    private final Integer routeId;
    private final Integer stationAggregateId;

    public GetRouteStationCommand(UnitOfWork unitOfWork, String serviceName, Integer routeId, Integer stationAggregateId) {
