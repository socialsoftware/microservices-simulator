package pt.ulisboa.tecnico.socialsoftware.trainticket.microservices.payment.coordination.functionalities;
...
import pt.ulisboa.tecnico.socialsoftware.trainticket.microservices.payment.coordination.sagas.*;
...
public class PaymentFunctionalities {
    ...
    private void checkInput(PaymentDto paymentDto) {
        if (paymentDto.getPaymentDate() == null) {
            throw new TrainTicketException(PAYMENT_MISSING_PAYMENTDATE);
        }
}

    private void checkInput(CreatePaymentRequestDto createRequest) {
        if (createRequest.getPaymentDate() == null) {
            throw new TrainTicketException(PAYMENT_MISSING_PAYMENTDATE);
        }
}
}